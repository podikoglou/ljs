  ...
  assert_parse_ok("delete x;", {
    {
      ...
      expression = { type = "DeleteExpression", argument = { type = "Identifier", name = "x" } },
    },
  })
end)
...
test("parse delete null", function()
  assert_parse_ok("delete null;", {
    {
      type = "ExpressionStatement",
      expression = { type = "DeleteExpression", argument = { type = "NullLiteral" } },
    },
  })
end)
...
test("parse delete undefined", function()
  assert_parse_ok("delete undefined;", {
    {
      type = "ExpressionStatement",
      expression = { type = "DeleteExpression", argument = { type = "UndefinedLiteral" } },
    },
  })
end)
  ...
  assert_parse_ok("delete x + 1;", {
    {
      ...
      expression = {
        type = "BinaryExpression",
        operator = "+",
        left = { type = "DeleteExpression", argument = { type = "Identifier", name = "x" } },
        right = { type = "NumberLiteral", value = 1 },
      },
    },
  })
  ...
  assert_parse_ok("delete x && delete y;", {
    {
      ...
      expression = {
        ...
        operator = "&&",
        left = { type = "DeleteExpression", argument = { type = "Identifier", name = "x" } },
        right = { type = "DeleteExpression", argument = { type = "Identifier", name = "y" } },
      },
    },
  })
end)
  ...
  assert_parse_ok("delete x ? 1 : 0;", {
    {
      ...
      expression = {
        ...
        test = { type = "DeleteExpression", argument = { type = "Identifier", name = "x" } },
  ...
  assert_parse_ok("result = delete x;", {
    {
      ...
      expression = {
        ...
        right = { type = "DeleteExpression", argument = { type = "Identifier", name = "x" } },
      },
    },
  })
end)
  ...
  assert_parse_ok("[delete x];", {
    {
      ...
      expression = {
        type = "ArrayExpression",
        elements = {
          { type = "DeleteExpression", argument = { type = "Identifier", name = "x" } },
        },
      },
    },
  })
...
test("parse multiple delete statements", function()
  assert_parse_ok("delete x; delete y; delete z;", {
    ...
    {
      type = "ExpressionStatement",
      expression = { type = "DeleteExpression", argument = { type = "Identifier", name = "y" } },
    },
    {
      type = "ExpressionStatement",
      expression = { type = "DeleteExpression", argument = { type = "Identifier", name = "z" } },
    },
  })
end)
...
test("parse throw delete x is not valid (throw expects expression, delete is expr)", function()
  assert_parse_ok("throw delete x;", {
    {
      type = "ThrowStatement",
      argument = { type = "DeleteExpression", argument = { type = "Identifier", name = "x" } },
    },
  })
end)
