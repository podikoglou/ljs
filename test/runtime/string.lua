...
test("string bracket indexing string numeric key negative returns undefined", function()
  assert_eq(exec_js('var s = "hello"; return s["-1"] === undefined;'), true)
end)

test("string bracket indexing OOB returns undefined", function()
  assert_eq(exec_js('return "hello"[5] === undefined;'), true)
end)

test("string bracket indexing negative returns undefined", function()
  assert_eq(exec_js('return "hello"[-1] === undefined;'), true)
end)
...
test("string bracket rejects whitespace-padded index", function()
  assert_js('"hello"[" 1"] === undefined', true)
end)

test("string bracket rejects hex index", function()
  assert_js('"hello"["0x0"] === undefined', true)
end)

test("string bracket rejects exponential index", function()
  assert_js('"hello"["1e0"] === undefined', true)
end)
...
test("string bracket rejects leading zero index", function()
  assert_js('"hello"["01"] === undefined', true)
end)

test("string bracket rejects negative zero index", function()
  assert_js('"hello"["-0"] === undefined', true)
end)
