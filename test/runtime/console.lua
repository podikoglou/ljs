...
test("console.log shows single hole in sparse array", function()
  local out = capture_stdout(function()
    exec_js("console.log([1,,3]);")
  end)
  assert_eq(out, "[ 1, <1 empty item>, 3 ]\n")
end)

test("console.log shows all-hole array", function()
  local out = capture_stdout(function()
    exec_js("console.log([,,,]);")
  end)
  assert_eq(out, "[ <3 empty items> ]\n")
end)

test("console.log shows explicit undefined as undefined not hole", function()
  local out = capture_stdout(function()
    exec_js("console.log([undefined]);")
  end)
  assert_eq(out, "[ undefined ]\n")
...
test("console.log shows multiple hole groups", function()
  local out = capture_stdout(function()
    exec_js("console.log([1,,3,,5]);")
  end)
  assert_eq(out, "[ 1, <1 empty item>, 3, <1 empty item>, 5 ]\n")
end)

test("console.log groups consecutive holes", function()
  local out = capture_stdout(function()
    exec_js("console.log([1,,,,5]);")
  end)
  assert_eq(out, "[ 1, <3 empty items>, 5 ]\n")
end)

test("console.log shows leading holes", function()
  local out = capture_stdout(function()
    exec_js("console.log([,,3]);")
  end)
  assert_eq(out, "[ <2 empty items>, 3 ]\n")
end)

test("console.log shows trailing hole", function()
  local out = capture_stdout(function()
    exec_js("console.log([1,,]);")
  end)
  assert_eq(out, "[ 1, <1 empty item> ]\n")
end)
