...
test("console.log joins multiple args with tab", function()
  local out = capture_stdout(function()
...
test("console.error joins multiple args with tab", function()
  local out = capture_stderr(function()
...
test("console.warn joins multiple args with tab after prefix", function()
  local out = capture_stderr(function()
...
test("console.info joins multiple args with tab", function()
  local out = capture_stdout(function()
