...
test("Object.prototype.toString via call on empty array", function()
  assert_eq(exec_js("return Object.prototype.toString.call([]);"), "[object Array]")
end)
...
test("Object.prototype.toString via call on arrow function", function()
  assert_eq(exec_js("return Object.prototype.toString.call(() => {});"), "[object Function]")
end)
...
test("Object.prototype.toString via call on TypeError", function()
  assert_eq(exec_js("return Object.prototype.toString.call(new TypeError());"), "[object Error]")
end)
...
test("Object.prototype.toString via call on null", function()
  assert_eq(exec_js("return Object.prototype.toString.call(null);"), "[object Null]")
end)

test("Object.prototype.toString via call on undefined", function()
  assert_eq(exec_js("return Object.prototype.toString.call(undefined);"), "[object Undefined]")
end)

test("Array.prototype.toString fallback to Object.prototype.toString when join is null", function()
  assert_eq(exec_js("let arr = [1, 2, 3]; arr.join = null; return arr.toString();"), "[object Array]")
end)

test("Array.prototype.toString fallback when join is a number", function()
  assert_eq(exec_js("let arr = [1, 2, 3]; arr.join = 42; return arr.toString();"), "[object Array]")
end)

test("Array.prototype.toString fallback when join is a string", function()
