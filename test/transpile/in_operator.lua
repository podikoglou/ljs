...
test('"x" in obj transpiles to _ljs_has_property', function()
  assert_eq(expr_code('"x" in obj'), 'local _ = _ljs_has_property(obj, "x")')
end)

test("0 in arr transpiles to _ljs_has_property with +1 offset", function()
