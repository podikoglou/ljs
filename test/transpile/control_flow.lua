...
test("full for with let init transpiles correctly", function()
  ...
  assert(code:find("while _ljs_to_boolean%(i < 10%) do"), "expected 'while _ljs_to_boolean(i < 10) do'")
...
test("for with expression init transpiles correctly", function()
  ...
  assert(code:find("while _ljs_to_boolean%(i < 5%) do"), "expected 'while _ljs_to_boolean(i < 5) do'")
end)
...
test("for with nil update transpiles correctly", function()
  ...
  assert(code:find("while _ljs_to_boolean%(x < 5%) do"), "expected 'while _ljs_to_boolean(x < 5) do'")
...
test("for with nil init transpiles correctly", function()
  ...
  assert(code:find("while _ljs_to_boolean%(x < 10%) do"), "expected 'while _ljs_to_boolean(x < 10) do'")
...
test("nested for loops transpile with correct indentation", function()
  ...
  assert(code:find("while _ljs_to_boolean%(j < 3%) do"), "inner while")
end)
...
test("for(;;) var init transpiles same as let", function()
  ...
  assert(code:find("while _ljs_to_boolean%(i < 3%) do"), "expected while condition")
end)
