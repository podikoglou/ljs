...
-- ============================================================================
-- Integration tests — delete expression
-- ============================================================================

test("delete integration: removes property from object", function()
  local output = run_js([[
    let obj = {a: 1, b: 2};
    delete obj.a;
    console.log(obj.a);
  ...
  assert_eq(output:gsub("%s+", ""), "nil2")
end)

test("delete integration: removes computed property", function()
  local output = run_js([[
    let obj = {x: 10, y: 20};
    delete obj["x"];
    console.log(obj.x);
  ...
  assert_eq(output:gsub("%s+", ""), "nil20")
end)

test("delete integration: nested member delete", function()
  local output = run_js([[
    let obj = {inner: {a: 1, b: 2}};
    delete obj.inner.a;
    console.log(obj.inner.a);
    console.log(obj.inner.b);
  ]])
  assert_eq(output:gsub("%s+", ""), "nil2")
end)

test("delete integration: returns true for member", function()
  local output = run_js([[
    let obj = {a: 1};
    let r = delete obj.a;
    console.log(r);
...
test("delete integration: returns true for identifier", function()
  local output = run_js([[
    let x = 5;
    let r = delete x;
    console.log(r);
  ...
  assert_eq(output:gsub("%s+", ""), "true5")
end)

test("delete integration: returns true for literal", function()
  local output = run_js([[
    let r = delete 42;
    console.log(r);
  ]])
...
test("delete integration: delete then check with ternary", function()
  local output = run_js([[
    let obj = {a: 1};
    delete obj.a;
    console.log(obj.a === nil ? "gone" : "exists");
  ]])
  assert_eq(output:gsub("%s+", ""), "gone")
end)

test("delete integration: multiple deletes on same object", function()
  local output = run_js([[
    let obj = {a: 1, b: 2, c: 3};
    delete obj.a;
    delete obj.b;
  ...
  assert_eq(output:gsub("%s+", ""), "nilnil3")
end)

test("delete integration: delete in while loop", function()
  local output = run_js([[
    let obj = {a: 1, b: 2, c: 3};
    let i = 0;
    while (i < 3) {
  ...
  assert_eq(output:gsub("%s+", ""), "nilnilnil")
end)
